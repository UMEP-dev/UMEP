    ...
    def run(self):
        ...
        try:
            ...
            for (
                ...
                if (
                    self.dlg.checkBoxOnlyBuilding.isChecked()
                ...
                if cal == 1:
                    ...
                    wallarea = np.sum(wa.findwalls(dsm_array, 2.0))
                    gridArea = (abs(bbox[2] - bbox[0])) * (
                        abs(bbox[1] - bbox[3])
                    )
            ...
            np.savetxt(
                self.folderPath[0] + "/" + pre + "_" + "IMPGrid_isotropic.txt",
                arrmatsave,
                fmt=numformat2,
                delimiter=" ",
                header=header2,
