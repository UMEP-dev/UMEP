...
class UWGAnalyser:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "UWGAnalyser_{}.qm".format(locale)
        )
        ...
        self.actions = []
        self.menu = self.tr("&UWG Analyser")
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr("&UWG Analyser"), action)
    ...
    def folder_path_inmodel(self):
        ...
        if result == 1:
            ...
            uwgDict = read_uwg_file(
                self.folderPath[0], self.infileList[0][:-4]
            )
            mm = uwgDict["Month"]
            dd = uwgDict["Day"]
            nDays = uwgDict["nDay"]
