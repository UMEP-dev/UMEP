            ...
            for p in range(np.shape(wallmatrix)[0]):
                if wallsun[wallrow[p], wallcol[p]] > 0:  # Sections in sun
                    ...
                    if (
                        ...
                        wallmatrix[
                            p,
                            0 : wallstot[wallrow[p], wallcol[p]] / voxelheight,
                        ] = (
                        ...
                        wallmatrix[
                            ...
                            - 1 : wallstot[wallrow[p], wallcol[p]]
                            / voxelheight,
                        ] = (
                            Iw[wallrow[p], wallcol[p]]
                            + Dw[wallrow[p], wallcol[p]]
                ...
                if usevegdem == 1 and wallshve[wallrow[p], wallcol[p]] > 0:
                    wallmatrix[
                        ...
                        0 : wallshve[
                            wallrow[p],
                            wallcol[p] + wallsh[wallrow[p], wallcol[p]],
                        ]
                        / voxelheight,
                    ] = (
                ...
                if (
                    ...
                    wallmatrix[
                        p, 0 : wallsh[wallrow[p], wallcol[p]] / voxelheight
                    ] = Rw[wallrow[p], wallcol[p]]
                    ...
                    for p in range(np.shape(wallmatrix)[0]):
                        if (
                            ...
                            if (
                                ...
                                wallmatrix[
                                    p,
                                    0 : wallstot[wallrow[p], wallcol[p]]
                                    / voxelheight,
                                ] = (
                                    Iw[wallrow[p], wallcol[p]]
                                    + Dw[wallrow[p], wallcol[p]]
                        ...
                        # sections in vegetation shade
                        if wallshve[wallrow[p], wallcol[p]] > 0:
                            wallmatrix[
                                p,
                                0 : wallshve[
                                    wallrow[p],
                        ...
                        if (
                            ...
                            wallmatrix[
                                p,
                                0 : wallsh[wallrow[p], wallcol[p]]
                                / voxelheight,
                            ] = Rw[wallrow[p], wallcol[p]]

                    Energymonthwall[:, :, t - 3] = Energymonthwall[
                        :, :, t - 3
                    ] + np.copy(wallmatrix)
