...
class WallHeight(object):
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "WallHeight_{}.qm".format(locale)
        )
        ...
        self.dlg.pushButtonSaveHeight.clicked.connect(
            self.save_file_place_height
        )
        self.dlg.pushButtonSaveAspect.clicked.connect(
            self.save_file_place_aspect
        )
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr("&Wall Height"), action)
    ...
    def run(self):
        try:
            ...
            QMessageBox.critical(
                None,
                "Error",
                "This plugin requires the scipy package to "
    ...
    def start_progress(self):
        ...
        if self.filePathH is None:
            QMessageBox.critical(
                self.dlg, "Error", "No wall height file specified"
            )
        else:
    ...
    def workerFinished(self, ret):
        ...
        if ret is not None:
            ...
            QMessageBox.information(
                None, "Wall aspect", "Calculation succesfully completed"
            )
