...
class Population:
    ...
    def setResPop(
        ...
        """
        return self.residential.addInput(
            input,
            startTime,
            attributeToUse,
            inputFieldId,
    ...
    def injectResPop(self, input, startTime, attributeToUse, epsgCode=None):
        ...
        """
        return self.residential.injectInput(
    ...
    def injectWorkPop(self, input, startTime, attributeToUse, epsgCode=None):
        ...
        :return: QgsVectorLayer of input data
        """
        return self.workday.injectInput(
            input, epsgCode, attributeToUse, startTime
        )
    ...
    def getPopTable(self, requestDate, popType):
        ...
        combined_refined = combined_refined.divide(
            self.residential.getAreas(), axis="index"
        )
...
def testIt():
    ...
    resid = {}
    resid["shapefile"] = (
        "C:\\Users\\pn910202\\Dropbox\\Shapefilecombos\\populations\\popOA2014.shp"
    )
    resid["epsg"] = 27700
    # Can be found in QGIS > view attributes table
    resid["field_to_use"] = "Pop"
    resid["start_date"] = datetime.strptime("2014-01-01", "%Y-%m-%d")

    # Raw workplace population data in LSOAs
    wp = {}
    wp["shapefile"] = (
        "C:\\Users\\pn910202\\Dropbox\\Shapefilecombos\\PopDens\\PopDens_2014_LSOA.shp"
    )
    wp["epsg"] = 27700
    # Can be found in QGIS > view attributes table
    wp["field_to_use"] = "WorkPop"
