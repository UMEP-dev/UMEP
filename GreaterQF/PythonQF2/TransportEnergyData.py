...
class TransportEnergyData:
    ...
    def __init__(self, logger=LookupLogger()):
        ...
        self.energy = SpatialTemporalResampler(logger=self.logger)
    ...
    def setRoadLengths(
        self, input, startTime, attributeToUse, weight_by=None, epsgCode=None
    ):
        self.roadLengths.addInput(
            input,
            startTime,
            attributeToUse,
            weight_by=weight_by,
    ...
    def setVehicleOwnership(
        self, input, startTime, attributeToUse, weight_by=None, epsgCode=None
    ):
        self.vehicleOwnership.addInput(
            input,
            startTime,
            attributeToUse,
            weight_by=weight_by,
    ...
    def calculateEnergy(self):
        ...
        raise Exception(
            "SOMETHING MAGICAL HAPPENS HERE BUT IT IS NOT YET IMPLEMENTED"
        )
...
def testIt():
    ...
    trans = {}
    trans["shapefile"] = (
        "C:\\Users\\pn910202\\Dropbox\\Shapefilecombos\\Transport\\08transport.shp"
    )
    trans["epsg"] = 27700
    trans["field_to_use"] = [
        "Motorc",
