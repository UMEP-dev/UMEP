...
from xlutils.tests.fixtures import (
    test_files,
    test_xls_path,
    make_book,
    make_sheet,
    ...
    def test_custom_getworkbooks(self):
        ...
        compare(
            ...
            [
                ...
                (
                    "workbook",
                    (C("xlutils.tests.fixtures.DummyBook"), "test.xls"),
                    {},
                ),
...
class TestBaseFilter(TestCase):
    ...
    def test_start(self):
        self.filter.start()
        self.assertEqual(self.tf.method_calls, [("start", (), {})])

    def test_workbook(self):
        self.filter.workbook("rdbook", "wtbook_name")
        self.assertEqual(
            self.tf.method_calls, [("workbook", ("rdbook", "wtbook_name"), {})]
        )

    def test_sheet(self):
        self.filter.sheet("rdsheet", "wtsheet_name")
        self.assertEqual(
            self.tf.method_calls, [("sheet", ("rdsheet", "wtsheet_name"), {})]
        )

    def test_set_rdsheet(self):
        self.filter.set_rdsheet("rdsheet2")
        self.assertEqual(
            self.tf.method_calls, [("set_rdsheet", ("rdsheet2",), {})]
        )

    def test_row(self):
        self.filter.row(0, 1)
        self.assertEqual(self.tf.method_calls, [("row", (0, 1), {})])

    def test_cell(self):
        self.filter.cell(0, 1, 2, 3)
        self.assertEqual(self.tf.method_calls, [("cell", (0, 1, 2, 3), {})])

    def test_finish(self):
        self.filter.finish()
        self.assertEqual(self.tf.method_calls, [("finish", (), {})])
...
class TestErrorFilter(TestCase):
    ...
    def test_set_rdsheet_1(self, h):
        ...
        h.check(
            (
                ...
                "ERROR",
                va(
                    "Cell A1 of sheet b'Sheet2' contains a bad value: error (#NULL!)"
                ),
            ),
    ...
    def test_set_rdsheet_2(self, h):
        ...
        compare(
            ...
            [
                ...
                (
                    "sheet",
                    (C("xlrd.sheet.Sheet", name="new", strict=False), "new"),
                    {},
                ),
                ("row", (0, 0), {}),
                ("cell", (0, 0, 0, 0), {}),
    ...
    def test_multiple_workbooks_with_same_name(self, h):
        ...
        compare(
            ...
            [
                ...
                (
                    "sheet",
                    (C("xlrd.sheet.Sheet", name="new1", strict=False), "new1"),
                    {},
                ),
                ("row", (0, 0), {}),
                ("cell", (0, 0, 0, 0), {}),
                ...
                (
                    "sheet",
                    (C("xlrd.sheet.Sheet", name="new2", strict=False), "new2"),
                    {},
                ),
                ("row", (0, 0), {}),
                ("cell", (0, 0, 0, 0), {}),
    ...
    def test_start(self, d):
        ...
        compare(m.method_calls, [("start", (), {}), ("finish", (), {})])
        ...
        compare(
            ...
            [
                ...
                (
                    "sheet",
                    (
                        C("xlrd.sheet.Sheet", name="Sheet", strict=False),
                        "Sheet",
                    ),
                    {},
                ),
    ...
    def test_set_rdsheet_cols(self, h):
        ...
        compare(
            ...
            [
                ...
                (
                    "workbook",
                    (C("xlutils.tests.fixtures.DummyBook"), "new.xls"),
                    {},
                ),
                (
                    "sheet",
                    (
                        C("xlrd.sheet.Sheet", name="Sheet1", strict=False),
                        "new",
                    ),
                    {},
                ),
                ...
                (
                    "set_rdsheet",
                    (C("xlrd.sheet.Sheet", name="Sheet2", strict=False),),
                    {},
                ),
                ("cell", (0, 0, 0, 1), {}),
                ("finish", (), {}),
...
class TestBaseWriter(TestCase):
        ...
        **provided_overrides
        ...
        def assertEqual(e, a, overrides, t, *names):
            for name in names:
                ...
                aa = getattr(a, name)
                self.assertEqual(
                    aa, ea, "%s: %r(actual)!=%r(expected)" % (name, aa, ea)
                )

        assertEqual(e, a, overrides, "book", "nsheets", "datemode")
        ...
        for sheet_x in range(a.nsheets):
            ...
            for row_x in range(ash.nrows):
                ...
                for col_x in range(ash.ncols):
                    ...
                    assertEqual(ec, ac, overrides, "cell", "ctype", "value")
                    self.note_index(ac, ec, "xf_index")
        ...
        for ai, eis in self.noted_indexes["format_key"].items():
            ...
            for ei in eis:
                ef = e.format_map[ei]
                assertEqual(ef, af, overrides, "format", "format_str", "type")
    ...
    def test_single_workbook_no_formatting(self):
        ...
        r = XLRDReader(
            open_workbook(os.path.join(test_files, "testall.xls")),
    ...
    def test_multiple_workbooks(self):
        ...
        self.check_file(
            w, os.path.join(test_files, "test.xls"), 18, 21, 76, 75, 7, 4
        )
        self.check_file(
            w,
            os.path.join(test_files, "testnoformatting.xls"),
            18,
            17,
            75,
            75,
    ...
    def test_bogus_sheet_name(self):
        ...
        # fire methods on writer
        with ShouldRaise(
            ValueError("A sheet named 'sheet' has already been added!")
        ):
            r(TestWriter())
    ...
    def test_empty_sheet_name(self):
        ...
        # fire methods on writer
        with ShouldRaise(
            ValueError("Empty sheet name will result in invalid Excel file!")
        ):
            r(TestWriter())
...
class TestXLWTWriter(TestCase):
    ...
    def test_one_file(self):
        r = GlobReader(os.path.join(test_files, "test.xls"))
        r(self.w)
        compare(self.w.output, [("test.xls", C("xlwt.Workbook"))])
    ...
    def test_multiple_files_same_name(self):
        ...
        compare(self.w.output[0][1].get_sheet(0).name, "new1")
        compare(self.w.output[1][1].get_sheet(0).name, "new2")
...
class TestTestReader(TestCase):
    ...
    def test(self):
        r = TestReader(
            test1=[
                ("Sheet1", [["R1C1", "R1C2"], ["R2C1", "R2C2"]]),
                ("Sheet2", [["R3C1", "R3C2"], ["R4C1", "R4C2"]]),
            ],
            test2=[
                ("Sheet3", [["R5C1", "R5C2"], ["R6C1", "R6C2"]]),
                ("Sheet4", [["R7C1", "R7C2"], ["R8C1", "R8C2"]]),
            ],
        )
        f = Mock()
        r(f)
        compare(
            [
                ...
                (
                    "workbook",
                    (C("xlutils.tests.fixtures.DummyBook"), "test1.xls"),
                    {},
                ),
                ("sheet", (C("xlrd.sheet.Sheet"), "Sheet1"), {}),
                ("row", (0, 0), {}),
                ...
                (
                    "workbook",
                    (C("xlutils.tests.fixtures.DummyBook"), "test2.xls"),
                    {},
                ),
    ...
    def test_setup(self):
        ...
        r.setup(("Sheet1", [["R1C1"]]), test1=[("Sheet2", [["R2C1"]])])
        r(f)
        compare(
            [
                ("start", (), {}),
