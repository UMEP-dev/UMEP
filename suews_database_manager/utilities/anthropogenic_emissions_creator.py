...
def setup_anthropogenic_emission_manager(self, dlg, db_dict, db_path):
    ...
    def fill_cboxes():
        ...
        dlg.comboBoxBaseAnEm.addItems(
            db_dict["AnthropogenicEmission"]["nameOrigin"].tolist()
        )
    ...
    def base_AnEm_changed():
        ...
        if dlg.comboBoxBaseAnEm.currentIndex() != -1:
            ...
            AnEm_sel = db_dict["AnthropogenicEmission"][
                db_dict["AnthropogenicEmission"]["nameOrigin"] == base_irr
            ]
            ...
            # Set crrect model
            try:
                model_index = dlg.comboBoxModel.findText(
                    str(AnEm_sel["Model"].item())
                )
    ...
    def add_AnEm():
        ...
        db_dict["AnthropogenicEmission"] = concat(
            [db_dict["AnthropogenicEmission"], new_edit]
        )
