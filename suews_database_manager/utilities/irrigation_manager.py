...
def setup_irrigation_manager(self, dlg, db_dict, db_path):
    ...
    def fill_cboxes():
        ...
        dlg.comboBoxBaseIrr.addItems(
            db_dict["Irrigation"]["nameOrigin"].tolist()
        )
    ...
    def base_irr_changed():
        ...
        irr_sel = db_dict["Irrigation"][
            db_dict["Irrigation"]["nameOrigin"] == base_irr
        ]
    ...
    def add_irr():
        ...
        QMessageBox.information(
            None, "Succesful", "Irrigation Entry added to your local database"
        )
        fill_cboxes()
